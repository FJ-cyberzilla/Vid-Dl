...
from sota_dl.infrastructure.adapters.drm_factory import get_best_drm_service, RemoteFirebaseDRMService
from sota_dl.core.protocols import DRMService

# Test that the factory returns RemoteFirebaseDRMService when local dependencies are missing
...
def test_get_best_drm_service_fallback(mock_create_drm):
    ...
    device_path = Path("/tmp/dummy.wvd")
