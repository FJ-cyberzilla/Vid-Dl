...
def test_get_audio_quality(mock_print: Any, mock_ask: MagicMock) -> None:
...
@patch("sota_dl.ui.prompts.Prompt.ask")
@patch("sota_dl.ui.prompts.console.print")
def test_get_video_quality(mock_print: Any, mock_ask: MagicMock) -> None:
...
@patch("sota_dl.ui.prompts.console.print")
def test_get_quality_choice_audio(
    mock_print: Any, mock_video: MagicMock, mock_audio: MagicMock
) -> None:
...
@patch("sota_dl.ui.prompts.get_video_quality")
@patch("sota_dl.ui.prompts.console.print")
def test_get_quality_choice_video(
    mock_print: Any, mock_video: MagicMock, mock_audio: MagicMock
) -> None:
